...
namespace WindowsFormsApp222
{
    ...
    {
        public static string DelLineContentBeforeKeyword { get; private set; } = string.Empty;
        ...
        public FormKeyWordDelLineContentBefore()
        {
        ...
        private void InitializeComponentе()
        {
            ...
            lblTitle = new Label() { Text = "Удаление содержимого до КС", AutoSize = true, Location = new System.Drawing.Point(40, 10) };
        ...
        {
            DelLineContentBeforeKeyword = txtKeyword.Text;
            this.Close();
        }
    }
}
